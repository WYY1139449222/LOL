(function (jq) {
    var posterTvGrid2 = function (o, options, data) {
        this.parent = jq("#" + o);
        this.body = jq("body");
    ...
    posterTvGrid2.prototype = {
        reset: function (options) {
            ...
            this.preLeft = 0;
            this.nextLeft = this.options.width - 192;
            this.preNLeft = -192;
            this.nextNLeft = this.options.width;
            this.pageNowLeft = (this.options.width - 240) / 2;
            this.drawContent();
        },
        drawContent: function () {
            ...
            for (var item = 0,
                    i = 1,
                    l = this.data.length; item < l; ++item, ++i) {
        ...
        initContent: function () {
            ...
            this.parent.find(".contentHolderUnit:nth-child(" + this.pageNow + ")").addClass("active");
            this.parent.find(".contentHolderUnit:nth-child(" + this.pageNow + ")").css({
                width: '385px',
                height: '510px',
                opacity: 1,
                left: this.pageNowLeft - 70 + 'px',
                zIndex: 3,
                marginTop: 0
            });
        ...
        turnpage: function (page, dir) {
            ...
            var run = function (page, dir, t) {
                ...
                if (dir == 'left') {
                    ...
                    _this.parent.find(".contentHolderUnit").removeClass("active");
                    _this.parent.find(".contentHolderUnit:nth-child(" + page + ")").addClass("active");
                    _this.parent.find(".contentHolderUnit:nth-child(" + page + ")").animate({
                            opacity: 1,
                            left: _this.pageNowLeft - 70 + 'px',
                            height: '510px',
                            width: '385px',
                            zIndex: 3,
                            marginTop: '0'
    ...
    window.posterTvGrid2 = posterTvGrid2;
})(jQuery);